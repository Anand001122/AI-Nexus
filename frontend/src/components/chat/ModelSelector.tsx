  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center justify-between px-3 sm:px-5 py-2 sm:py-3.5 glass rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 sm:min-w-[200px] group border border-blue-500/20"
        ...
        <div className="absolute top-full left-0 z-[100] w-full mt-3 glass rounded-2xl shadow-2xl max-h-80 overflow-y-auto scrollbar-thin animate-in">
          <div className="p-3">
            ...
            {AI_MODELS.map((model) => {
              ...
              const IconComponent = model ? (LucideIcons as any)[model.icon] : LucideIcons.User || LucideIcons.HelpCircle;
